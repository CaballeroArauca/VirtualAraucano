<?php
		...
		public function get_grupos(){
			$this->_sql="SELECT `id_grupo`,`nombre_grupo`, `modalidad_grupo` FROM `grupos` WHERE `id_grupo` NOT IN (SELECT `grupos_id_grupo` FROM `calificaciones`) ORDER BY `ubicacion_grupo`";
			$row = $this->get_query();
			return $row;
		}
